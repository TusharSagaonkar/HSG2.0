...
DJANGO_APPS = [
    ...
    "django.contrib.humanize",  # Handy template filters like intcomma/timesince
...
MIGRATION_MODULES = {"sites": "housing_accounting.contrib.sites.migrations"}
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "housing_accounting.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "housing_accounting.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "housing_accounting.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "housing_accounting.users.forms.UserSocialSignupForm"}
