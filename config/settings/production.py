...
for host in env.list("DJANGO_ALLOWED_HOSTS", default=[]):
...
if redis_url:
    ...
    CACHES = {
        "default": {
            ...
            "LOCATION": "render-production-cache",
        },
    }
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Housing Accounting System <noreply@localhost>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    ...
    default="[Housing Accounting System] ",
)
